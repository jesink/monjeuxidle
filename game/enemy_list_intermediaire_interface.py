...
class EnemyListIntermediaireInterface:
    def __init__(self, screen, character, combat_interface_class):
        ...
        # Créez une liste d'ennemis avec des statistiques adaptées (par exemple, pour les niveaux 30 à 40)
        self.enemies = [
            {"level": level, "stats": self.generate_stats(level)}
            for level in range(30, 41)
        ]
