...
class EnemyListDifficileInterface:
    def __init__(self, screen, character, combat_interface_class):
        ...
        # Créez une liste d'ennemis avec des statistiques adaptées (par exemple, pour les niveaux 50 à 60)
        self.enemies = [
            {"level": level, "stats": self.generate_stats(level)}
            for level in range(50, 61)
        ]
